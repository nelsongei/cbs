    ...
    <div class="col-md-4 col-12 fxt-bg-color">
        <div class="fxt-content">
            ...
            <div class="fxt-footer">
                ...
                <div style="background-color: white; text-align:center; margin-top: -5px"
                    class="fxt-transformY-50 fxt-transition-delay-10">
                    <p>
                        <span>© <?php
                        echo date('Y');
                        ?> Powered by</span> &nbsp; <img src="{{ asset('images/logo.jpg') }}"
                            alt="Lixnet" class="lixnet-logo">
                    </p>
                </div>
            </div>
        </div>

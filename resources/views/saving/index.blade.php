...
@section('content')
                    ...
                    <div class="">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <button type="button" data-toggle="modal" data-target="#export-saving" id="assign"
                                        ...
                                        @forelse($savings as $saving)
                                            <tr>
                                                <td><input type="checkbox" name="id[]" class="checkbox"
                                                        id="checkItem{{ $saving->id }}" value="{{ $saving->id }}"></td>
                                                <td>{{ $saving->member->firstname . ' ' . $saving->member->middlename . ' ' . $saving->member->lastname }}
                                                </td>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item text-success"
                                                                href="{{ url('saving/view/' . $saving->id) }}">View</a>
    ...
    <div class="modal fade" id="export-saving">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{ url('saving/export') }}" method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <img src="{{ asset('images/print.gif') }}" alt="print" height="200"
                                    width="200">
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                ...
                                <div class="form-group" id="year">
                                    ...
                                    <div class="right-inner-addon ">
                                        ...
                                        <input class="form-control datepicker42" readonly="readonly" placeholder=""
                                            type="text" name="year" id="dropper_default"
                                            value="{{ date('Y') }}">
                                    </div>
                                </div>
                                <div id="custom">
                                ...
                                <div class="form-group" id="select_date">
                                    ...
                                    <div class="right-inner-addon ">
                                        ...
                                        <input class="form-control datepicker" readonly="readonly" placeholder=""
                                            type="text" name="date" id="date" value="{{ date('Y-m-d') }}">
                                    </div>
                                </div>
                                <div class="form-group" id="month">
                                    ...
                                    <div class="right-inner-addon ">
                                        ...
                                        <input class="form-control datepicker2" readonly="readonly" placeholder=""
                                            type="text" name="month" id="date" value="{{ date('m-Y') }}">
                                    </div>
                                </div>
                                <div class="form-group">
    ...
    <div class="modal fade" id="upload-savings">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{ url('saving/upload') }}" method="post" accept-charset="UTF-8"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <img src="{{ asset('images/cloudUpload.gif') }}" alt="upload" height="200"
                                    width="350">
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">

            ...
            <div class="page-wrapper">
                                ...
                                <div class="card-body">
                                    @forelse($bank_accounts as $account)
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <div class="bal">
                                                            <h4>
                                                                <font color="#0BAEED">{{ $account->account_name }}</font>
                                                            </h4>
                                                            <h6>{{ $account->account_number }}</h6>
                                                        </div>
                                                        <div class="bal" style="border-left: 1px solid #ddd !important;">
                                                            <h4>
                                                                <font color="#0BAEED">{{ $account->bank_name }}</font>
                                                            </h4>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td colspan="1" style="border-bottom: 1px solid #ddd !important;">
                                                        <font color="green">
                                                        ...
                                                        <tr>
                                                            @if ($acSt->bal_bd !== null && $acSt->is_reconciled === 0)
                                                                <form role="form"
                                                                    ...
                                                                    <td>
                                                                        <h4>
                                                                            <font color="#0BAEED">Ksh.
                                                                                {{ asMoney($acSt->bal_bd) }}</font>
                                                                        </h4>
              ...
              <h6><strong>{{ date('M j, Y', strtotime($acSt->stmt_date)) }}</strong></h6> -->
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select name="book_account_id"
                                                                                ...
                                                                                @foreach ($bkAccounts as $bookAc)
                                                                                    <option value="{{ $bookAc->id }}">
                                                                                        {{ $bookAc->category->name }}
                                                                                        - {{ $bookAc->name }}</option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                    ...
                                                    @elseif($acSt->is_reconciled === 1)
                                                        <td colspan="3">
                                                            <h4>
                                                                <font color="#0BAEED">Ksh. {{ asMoney($acSt->bal_bd) }}
                                                                </font>
                                                            </h4>
                                                            <h6>Bank Statement Balance for
                                                                <strong>{{ $acSt->stmt_month }}</strong>
                                                            </h6>
                                                            <h6>
                                                                <font color="green">THE BANK STATEMENT HAS BEEN
                                                                    RECONCILED.</font>
                                                            </h6>
                                                        </td>
              ...
              <a href="{{ URL::to('bankAccounts/reconcile/' . $account->id) }}" class="btn btn-success btn-sm">Reconciliation History</a>
                                            ...
                                            @else
                                                <td colspan="1">
                                                    <h4>
                                                        <font color="#0BAEED">Ksh. {{ asMoney(0) }}</font>
                                                    </h4>
                                                    <h6>Bank Statement Balance</h6>
                                                    <h6>
                                                        <font color="#E74C3C">NO STATEMENT TRANSACTIONS UPLOADED
                                                            FOR LAST MONTH
                                                            YET</font>
                                                    </h6>
                                                </td>
                                                <td colspan="2"
                                                    ...
                                                    <a href="#uploadStatement{{ $account->id }}"
                                                        class="btn btn-success btn-sm" data-toggle="modal">Upload Bank
                                                        Statement</a>
                                                </td>
                                    @endif
                                    </tbody>
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <div style="margin-left: 20px;">
                                                                    <p>
                                                                        ...
                                                                        &#10003; <font color="red"><strong>NB: The above
                                                                                details should be in a header row
                                                                                (Containing column headings)</strong></font>
                                                                    </p>
                                                                </div>
                                                                <hr>
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <div style="background:#E1F5FE; padding: 10px;">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="file" class="btn btn-info btn-sm"
                                ...
                                @empty
                                    <h4>
                                        <font color='red'>No Bank Accounts Available!</font>
                                    </h4>
                                    @endforelse
                                </div>
                            </div>

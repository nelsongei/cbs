                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <table class="table table-striped table-bordered mt-2">
                                                ...
                                                <tbody>
                                                    <?php $count=1;?>
                                                    @forelse ($loanCharges as $loan)
                                                    <tr>
                                                        <td>{{ $count++ }}</td>
                                                        <td>{{ $loan->charge->name }}</td>
                                                    ...
                                                    @empty
                                                        <tr>
                                                            <td colspan="4" align="center">
                                                                <i class="feather icon-cast fa-5x text-warning"></i>
                                                                <p>Add Loan Charges</p>
                                                            </td>
                                                        </tr>
                                                    @endforelse
                                                </tbody>
